...
const BUBBLES: Bubble[] = [
  {
    img: "/Ellipse225.png",
    name: "John Alex",
    text: "Hey Stowry, Store the charger in the bedroom drawer.",
    left: "-14%",
    top: "-2%",
  },
  {
    img: "/Ellipse226.png",
    name: "Desirae Lubin",
    text: "Hey Stowry, I kept the gate batteries in the living room shelf drawer.",
    left: "19%",
    top: "97%",
  },
  {
    ...
    text: "Hey Stowry, Put the extra ketchup in the kitchen cabinet.",
    left: "73%",
    top: "73%",
  },
  {
    img: "/Ellipse224.png",
    name: "Marcus Chen",
    text: "Hey Stowry, My passport is in the office desk's top drawer.",
    left: "-28%",
    top: "85%",
  },
  {
    img: "/Ellipse227.png",
    name: "Sarah Kim",
    text: "Hey Stowry, The spare car keys are in the hallway bowl.",
    left: "78%",
    top: "7%",
  },
];
...
const M_BUBBLES: MobBubble[] = [
  {
    img: "/Ellipse225.png",
    name: "John Alex",
    text: "Hey Stowry, Store this charger in the bedroom drawer.",
    left: "6%",
    top: "9%",
    side: "left",
  },
